    ...
    <div className="min-h-screen bg-gray-950 p-6 md:p-12 text-white">
      <div className="max-w-2xl mx-auto">
        ...
        <form onSubmit={handleSave} className="space-y-8">
          ...
          <div>
            ...
            <div className="flex items-center gap-4 bg-gray-900 border border-gray-800 rounded-xl p-4">
              {form.logo_url ? (
                ...
                <div className="h-14 w-14 rounded-lg bg-gray-800 flex items-center justify-center text-gray-600 text-xs">
                  None
                </div>
              )}
          ...
          {success && (
            <p className="text-emerald-400 text-xs font-bold bg-emerald-500/10 px-3 py-2 rounded-lg border border-emerald-500/20">
